...
<html>
    ...
    <body>
        ...
        <div class="content">
            <table width="100%">
            <form method="post" action="{{ route('team.add_member', ['teamId' => $team->teamId]) }}" id="form_update">
                @csrf
                    <tr>
                    ...
                    <tr>
                        <td class="input-title"></td><td style="padding-bottom:2.5rem;"class="center back"><button class="save" type="submit" form="form_update" value="Save">+&nbsp;&nbsp;Add</button></td>
                    </tr>
                </form>
            </table>
        </div>
